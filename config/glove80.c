...
/ {
    keymap {
        ...
        &kp LC(A)   &kp LC(V)   &kp LEFT   &kp RIGHT   &kp F17      &lt LAYER_Shift END   &kp BSPC   &magic LAYER_Magic 0   &kp LGUI   &kp DEL   &mt LCTRL ESC      &kp F6   &kp DOWN   &kp UP   &kp LC(C)   &kp DE_PLUS
        >;
        };
